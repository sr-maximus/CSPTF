...
This release establishes the architecture, identifiers, governance, domains, controls, tests, threat/weakness catalogs, risk model, templates, schemas and release validation package. Risk weights, thresholds and mappings are hypotheses pending calibration.
