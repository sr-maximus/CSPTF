...
Determinar, mediante evidencia verificable y validación no destructiva, si evaluar autenticación y ciclo de api keys reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **evaluar autenticación y ciclo de api keys** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **evaluar autenticación y ciclo de api keys** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden evaluar autenticación y ciclo de api keys.
