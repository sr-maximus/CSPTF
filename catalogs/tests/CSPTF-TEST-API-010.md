...
- **Related control:** CSPTF-CTRL-API-005
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si evaluar errores, logs y exposición de stack reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **evaluar errores, logs y exposición de stack** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **evaluar errores, logs y exposición de stack** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden evaluar errores, logs y exposición de stack.
