...
- **Related control:** CSPTF-CTRL-API-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si ejecutar pruebas de resiliencia no destructivas reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **ejecutar pruebas de resiliencia no destructivas** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **ejecutar pruebas de resiliencia no destructivas** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden ejecutar pruebas de resiliencia no destructivas.
