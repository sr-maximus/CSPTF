...
- **Related control:** CSPTF-CTRL-ARC-001
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si reconstruir la arquitectura lógica y física reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **reconstruir la arquitectura lógica y física** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **reconstruir la arquitectura lógica y física** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden reconstruir la arquitectura lógica y física.
