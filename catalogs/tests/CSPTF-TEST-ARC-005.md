...
- **Related control:** CSPTF-CTRL-ARC-003
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si revisar máquinas de estado y transiciones reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **revisar máquinas de estado y transiciones** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **revisar máquinas de estado y transiciones** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden revisar máquinas de estado y transiciones.
