...
- **Related control:** CSPTF-CTRL-BRG-001
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si documentar modelo de confianza del bridge reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **documentar modelo de confianza del bridge** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **documentar modelo de confianza del bridge** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden documentar modelo de confianza del bridge.
