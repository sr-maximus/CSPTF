...
- **Related control:** CSPTF-CTRL-BRG-003
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si comprobar quorum y rotación de validadores reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar quorum y rotación de validadores** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar quorum y rotación de validadores** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar quorum y rotación de validadores.
