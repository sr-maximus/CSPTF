...
- **Related control:** CSPTF-CTRL-BRG-005
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si ejecutar reconciliación de supply y reservas reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **ejecutar reconciliación de supply y reservas** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **ejecutar reconciliación de supply y reservas** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden ejecutar reconciliación de supply y reservas.
