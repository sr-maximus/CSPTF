...
Determinar, mediante evidencia verificable y validación no destructiva, si simular fallo de relayer o cadena reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **simular fallo de relayer o cadena** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **simular fallo de relayer o cadena** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden simular fallo de relayer o cadena.
