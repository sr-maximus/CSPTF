...
- **Related control:** CSPTF-CTRL-BRG-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si comprobar monitoreo y respuesta cross-chain reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar monitoreo y respuesta cross-chain** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar monitoreo y respuesta cross-chain** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar monitoreo y respuesta cross-chain.
...
AADAPT tactics: Initial Access; Execution; Credential Access; Impact; Fraud
