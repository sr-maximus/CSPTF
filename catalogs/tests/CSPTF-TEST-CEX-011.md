...
- **Related control:** CSPTF-CTRL-CEX-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si simular interrupción del matching en laboratorio reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **simular interrupción del matching en laboratorio** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **simular interrupción del matching en laboratorio** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden simular interrupción del matching en laboratorio.
...
AADAPT tactics: Initial Access; Credential Access; Lateral Movement; Collection; Impact; Fraud
