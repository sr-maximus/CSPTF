...
- **Related control:** CSPTF-CTRL-CRY-001
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si inventariar primitivas y parámetros reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **inventariar primitivas y parámetros** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **inventariar primitivas y parámetros** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden inventariar primitivas y parámetros.
