...
- **Related control:** CSPTF-CTRL-CRY-002
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si validar generación y reutilización de nonces reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **validar generación y reutilización de nonces** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **validar generación y reutilización de nonces** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden validar generación y reutilización de nonces.
