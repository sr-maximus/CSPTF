...
- **Related control:** CSPTF-CTRL-CRY-003
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si probar controles anti-replay en entorno autorizado reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **probar controles anti-replay en entorno autorizado** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **probar controles anti-replay en entorno autorizado** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden probar controles anti-replay en entorno autorizado.
