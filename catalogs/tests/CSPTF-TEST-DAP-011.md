...
- **Related control:** CSPTF-CTRL-DAP-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si simular manipulación de interfaz en laboratorio reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **simular manipulación de interfaz en laboratorio** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **simular manipulación de interfaz en laboratorio** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden simular manipulación de interfaz en laboratorio.
...
AADAPT tactics: Initial Access; Execution; Credential Access; Collection; Fraud
