...
Determinar, mediante evidencia verificable y validación no destructiva, si comprobar detección y revocación de sesiones reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar detección y revocación de sesiones** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar detección y revocación de sesiones** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar detección y revocación de sesiones.
