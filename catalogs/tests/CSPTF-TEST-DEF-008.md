...
- **Related control:** CSPTF-CTRL-DEF-004
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si comprobar incentivos y ataques de gobernanza económica reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar incentivos y ataques de gobernanza económica** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar incentivos y ataques de gobernanza económica** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar incentivos y ataques de gobernanza económica.
...
AADAPT tactics: Execution; Impact; Fraud
