...
- **Related control:** CSPTF-CTRL-DEF-005
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si ejecutar simulaciones históricas y de estrés reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **ejecutar simulaciones históricas y de estrés** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **ejecutar simulaciones históricas y de estrés** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden ejecutar simulaciones históricas y de estrés.
