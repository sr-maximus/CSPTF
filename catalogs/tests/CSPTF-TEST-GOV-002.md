...
- **Related control:** CSPTF-CTRL-GOV-001
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si validar el inventario de activos y flujos de valor reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **validar el inventario de activos y flujos de valor** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **validar el inventario de activos y flujos de valor** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden validar el inventario de activos y flujos de valor.
