...
- **Domain:** GOV
- **Minimum assurance:** AP1
- **Test type:** Revisión y validación controlada
- **Related control:** CSPTF-CTRL-GOV-002
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si revisar roles, escalamiento y autoridad de detención reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **revisar roles, escalamiento y autoridad de detención** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **revisar roles, escalamiento y autoridad de detención** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden revisar roles, escalamiento y autoridad de detención.
