...
Determinar, mediante evidencia verificable y validación no destructiva, si evaluar el modelo de amenazas y supuestos reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **evaluar el modelo de amenazas y supuestos** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **evaluar el modelo de amenazas y supuestos** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden evaluar el modelo de amenazas y supuestos.
