...
- **Related control:** CSPTF-CTRL-GOV-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si ejecutar una mesa de crisis previa a pruebas críticas reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **ejecutar una mesa de crisis previa a pruebas críticas** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **ejecutar una mesa de crisis previa a pruebas críticas** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden ejecutar una mesa de crisis previa a pruebas críticas.
...
AADAPT tactics: Reconnaissance; Resource Development; Initial Access; Impact; Fraud
