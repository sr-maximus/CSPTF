...
- **Related control:** CSPTF-CTRL-IAM-001
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si evaluar mfa y recuperación de acceso reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **evaluar mfa y recuperación de acceso** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **evaluar mfa y recuperación de acceso** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden evaluar mfa y recuperación de acceso.
