...
- **Related control:** CSPTF-CTRL-IAM-005
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si comprobar monitoreo de acciones críticas reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar monitoreo de acciones críticas** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar monitoreo de acciones críticas** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar monitoreo de acciones críticas.
