...
- **Related control:** CSPTF-CTRL-INF-003
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si comprobar integridad del pipeline y aprobaciones reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar integridad del pipeline y aprobaciones** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar integridad del pipeline y aprobaciones** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar integridad del pipeline y aprobaciones.
