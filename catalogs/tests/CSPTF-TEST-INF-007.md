...
Determinar, mediante evidencia verificable y validación no destructiva, si validar firma y procedencia de artefactos reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **validar firma y procedencia de artefactos** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **validar firma y procedencia de artefactos** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden validar firma y procedencia de artefactos.
