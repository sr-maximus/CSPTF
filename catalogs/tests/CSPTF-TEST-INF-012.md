...
- **Related control:** CSPTF-CTRL-INF-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si simular pérdida controlada de un componente reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **simular pérdida controlada de un componente** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **simular pérdida controlada de un componente** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden simular pérdida controlada de un componente.
...
AADAPT tactics: Initial Access; Execution; Privilege Escalation; Credential Access; Lateral Movement; Impact
