...
- **Related control:** CSPTF-CTRL-IRR-001
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si validar contactos, roles y autoridad reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **validar contactos, roles y autoridad** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **validar contactos, roles y autoridad** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden validar contactos, roles y autoridad.
