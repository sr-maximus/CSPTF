...
Determinar, mediante evidencia verificable y validación no destructiva, si validar restauración de servicios reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **validar restauración de servicios** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **validar restauración de servicios** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden validar restauración de servicios.
