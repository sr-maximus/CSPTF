...
- **Related control:** CSPTF-CTRL-IRR-004
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si comprobar reconciliación de balances reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar reconciliación de balances** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar reconciliación de balances** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar reconciliación de balances.
