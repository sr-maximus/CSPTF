...
Determinar, mediante evidencia verificable y validación no destructiva, si evaluar quorum, multisig o mpc reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **evaluar quorum, multisig o mpc** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **evaluar quorum, multisig o mpc** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden evaluar quorum, multisig o mpc.
