...
Determinar, mediante evidencia verificable y validación no destructiva, si comprobar rotación y revocación reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar rotación y revocación** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar rotación y revocación** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar rotación y revocación.
