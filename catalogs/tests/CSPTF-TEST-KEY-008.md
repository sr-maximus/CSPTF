...
- **Related control:** CSPTF-CTRL-KEY-004
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si evaluar recuperación y continuidad reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **evaluar recuperación y continuidad** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **evaluar recuperación y continuidad** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden evaluar recuperación y continuidad.
