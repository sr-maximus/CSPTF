...
- **Domain:** KEY
- **Minimum assurance:** AP3
- **Test type:** Simulación técnica autorizada
- **Related control:** CSPTF-CTRL-KEY-005
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si revisar firmware y cadena de suministro de dispositivos reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **revisar firmware y cadena de suministro de dispositivos** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **revisar firmware y cadena de suministro de dispositivos** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden revisar firmware y cadena de suministro de dispositivos.
...
AADAPT tactics: Credential Access; Collection; Defense Evasion; Impact; Fraud
