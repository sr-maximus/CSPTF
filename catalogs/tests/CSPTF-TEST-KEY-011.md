...
- **Related control:** CSPTF-CTRL-KEY-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si ejecutar simulación de compromiso de firmante reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **ejecutar simulación de compromiso de firmante** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **ejecutar simulación de compromiso de firmante** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden ejecutar simulación de compromiso de firmante.
