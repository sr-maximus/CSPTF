...
- **Related control:** CSPTF-CTRL-L2-001
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si validar construcción y envío de batches reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **validar construcción y envío de batches** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **validar construcción y envío de batches** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden validar construcción y envío de batches.
