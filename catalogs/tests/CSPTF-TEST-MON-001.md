...
Determinar, mediante evidencia verificable y validación no destructiva, si mapear telemetría a activos y amenazas reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **mapear telemetría a activos y amenazas** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **mapear telemetría a activos y amenazas** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden mapear telemetría a activos y amenazas.
