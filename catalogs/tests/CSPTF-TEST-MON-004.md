...
Determinar, mediante evidencia verificable y validación no destructiva, si evaluar eventos de contratos y nodos reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **evaluar eventos de contratos y nodos** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **evaluar eventos de contratos y nodos** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden evaluar eventos de contratos y nodos.
