...
- **Related control:** CSPTF-CTRL-MON-003
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si probar detecciones de cambios administrativos reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **probar detecciones de cambios administrativos** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **probar detecciones de cambios administrativos** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden probar detecciones de cambios administrativos.
