...
- **Related control:** CSPTF-CTRL-MON-004
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si comprobar correlación on-chain/off-chain reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar correlación on-chain/off-chain** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar correlación on-chain/off-chain** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar correlación on-chain/off-chain.
