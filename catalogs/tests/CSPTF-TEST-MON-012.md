...
- **Related control:** CSPTF-CTRL-MON-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si medir cobertura, precisión y mejora continua reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **medir cobertura, precisión y mejora continua** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **medir cobertura, precisión y mejora continua** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden medir cobertura, precisión y mejora continua.
...
AADAPT tactics: Defense Evasion; Collection; Impact; Fraud
