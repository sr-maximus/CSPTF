...
- **Related control:** CSPTF-CTRL-NET-003
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si evaluar protección contra double signing reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **evaluar protección contra double signing** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **evaluar protección contra double signing** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden evaluar protección contra double signing.
