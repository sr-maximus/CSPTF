...
Determinar, mediante evidencia verificable y validación no destructiva, si revisar límites de recursos y dos reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **revisar límites de recursos y dos** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **revisar límites de recursos y dos** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden revisar límites de recursos y dos.
