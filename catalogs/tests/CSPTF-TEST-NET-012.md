...
- **Domain:** NET
- **Minimum assurance:** AP4
- **Test type:** Ejercicio avanzado en laboratorio/fork
- **Related control:** CSPTF-CTRL-NET-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si ejecutar simulación de indisponibilidad de validador reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **ejecutar simulación de indisponibilidad de validador** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **ejecutar simulación de indisponibilidad de validador** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden ejecutar simulación de indisponibilidad de validador.
...
AADAPT tactics: Resource Development; Initial Access; Execution; Lateral Movement; Impact
