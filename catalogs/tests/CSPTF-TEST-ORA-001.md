...
- **Related control:** CSPTF-CTRL-ORA-001
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si inventariar fuentes y dependencias reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **inventariar fuentes y dependencias** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **inventariar fuentes y dependencias** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden inventariar fuentes y dependencias.
