...
- **Related control:** CSPTF-CTRL-ORA-002
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si comprobar autenticidad de actualizaciones reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar autenticidad de actualizaciones** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar autenticidad de actualizaciones** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar autenticidad de actualizaciones.
