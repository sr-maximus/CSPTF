...
- **Related control:** CSPTF-CTRL-REG-001
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si identificar obligaciones y alcance regulatorio reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **identificar obligaciones y alcance regulatorio** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **identificar obligaciones y alcance regulatorio** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden identificar obligaciones y alcance regulatorio.
