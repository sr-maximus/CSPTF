...
- **Related control:** CSPTF-CTRL-REG-004
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si comprobar retención y eliminación reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar retención y eliminación** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar retención y eliminación** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar retención y eliminación.
