...
- **Related control:** CSPTF-CTRL-REG-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si validar respuesta a solicitudes de titulares reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **validar respuesta a solicitudes de titulares** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **validar respuesta a solicitudes de titulares** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden validar respuesta a solicitudes de titulares.
...
AADAPT tactics: Collection; Defense Evasion; Impact; Fraud
