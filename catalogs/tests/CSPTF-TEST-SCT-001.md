...
- **Related control:** CSPTF-CTRL-SCT-001
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si verificar correspondencia fuente-bytecode reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **verificar correspondencia fuente-bytecode** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **verificar correspondencia fuente-bytecode** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden verificar correspondencia fuente-bytecode.
