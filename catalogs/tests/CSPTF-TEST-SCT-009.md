...
Determinar, mediante evidencia verificable y validación no destructiva, si revisar eventos y observabilidad reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **revisar eventos y observabilidad** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **revisar eventos y observabilidad** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden revisar eventos y observabilidad.
