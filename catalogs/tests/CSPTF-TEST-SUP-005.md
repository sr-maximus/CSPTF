...
Determinar, mediante evidencia verificable y validación no destructiva, si revisar runners y entornos de build reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **revisar runners y entornos de build** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **revisar runners y entornos de build** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden revisar runners y entornos de build.
