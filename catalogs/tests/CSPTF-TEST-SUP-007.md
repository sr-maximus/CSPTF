...
Determinar, mediante evidencia verificable y validación no destructiva, si comprobar builds reproducibles donde aplique reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **comprobar builds reproducibles donde aplique** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **comprobar builds reproducibles donde aplique** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden comprobar builds reproducibles donde aplique.
