...
- **Related control:** CSPTF-CTRL-SUP-006
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si simular revocación de componente comprometido reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **simular revocación de componente comprometido** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **simular revocación de componente comprometido** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden simular revocación de componente comprometido.
...
AADAPT tactics: Resource Development; Initial Access; Execution; Defense Evasion; Impact
