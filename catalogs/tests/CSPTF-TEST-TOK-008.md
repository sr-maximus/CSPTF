...
- **Related control:** CSPTF-CTRL-TOK-004
- **Status:** draft

## Objective

Determinar, mediante evidencia verificable y validación no destructiva, si evaluar tokens con comportamientos no convencionales reduce el riesgo esperado.
...
2. Obtener la línea base de diseño, configuración y evidencia relacionada con **evaluar tokens con comportamientos no convencionales** sin modificar el sistema.
...
4. Ejecutar una validación no destructiva de **evaluar tokens con comportamientos no convencionales** mediante consultas de solo lectura, revisión, test account, simulación, testnet o fork determinístico.
...
Existe diseño aprobado, la implementación coincide con el diseño, la evidencia demuestra eficacia y no se identifican rutas razonables que invaliden evaluar tokens con comportamientos no convencionales.
...
AADAPT tactics: Execution; Privilege Escalation; Impact; Fraud
