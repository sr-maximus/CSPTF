...
Actor externo, interno o automatizado intenta provocar secuestro de sesión vinculada a wallet para obtener acceso, control, beneficio económico, fraude, interrupción o ventaja estratégica.

## Assets at risk

frontend; backend BFF; wallet connectors; sesiones

## AADAPT tactic alignment

Initial Access; Execution; Credential Access; Collection; Fraud
