...
Actor externo, interno o automatizado intenta provocar duplicación o desanclaje de activo wrapped para obtener acceso, control, beneficio económico, fraude, interrupción o ventaja estratégica.

## Assets at risk

token contracts; NFT collections; metadata; minting

## AADAPT tactic alignment

Execution; Privilege Escalation; Impact; Fraud
