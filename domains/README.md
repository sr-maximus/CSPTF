...
CSPTF uses twenty domains. Domains are selected from the system architecture and assurance profile; they are not a linear checklist.
...
A domain may be excluded only through the process in `framework/01-scope-and-taxonomy.md`. Cross-domain dependencies must be retained in the threat model.
